...
int main(int argc, char *argv[])
{
    ...
    if (argc > 1 && strcmp(argv[1], "--help") == 0)
        usageErr("%s [secs [usecs [int-secs [intusecs]]]]");
    ...
    itv.it_value.tv_usec = (argc > 2) ? getLong(argv[2], 0, "secs") : 0;
    itv.it_interval.tv_sec = (argc > 3) ? getLong(argv[3], 0, "secs") : 0;
    itv.it_interval.tv_usec = (argc > 4) ? getLong(argv[4], 0, "secs") : 0;
