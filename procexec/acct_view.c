...
char *userNameFromId_(uid_t uid)
{
    struct passwd *pwd;

    //printf("About to get: %d\n", (int)uid); 
...
int main(int argc, char *argv[])
{
    ...
    printf("command  flags  term.  user    start time          CPU  elapse\n");
